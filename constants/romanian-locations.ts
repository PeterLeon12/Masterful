...
export const romanianCities: Record<string, string[]> = {
  ...
  'Maramureș': ['Baia Mare', 'Sighetu Marmației', 'Borșa', 'Cavnic', 'Seini', 'Târgu Lăpuș', 'Ulmeni', 'Săliștea de Sus', 'Săliștea de Sus', 'Săliștea de Sus'],
  'Mehedinți': ['Drobeta-Turnu Severin', 'Orșova', 'Strehaia', 'Vânju Mare', 'Baia de Aramă', 'Călărași', 'Corlățel', 'Dumbrava', 'Godeanu', 'Hinova'],
  'Mureș': ['Târgu Mureș', 'Reghin', 'Sighișoara', 'Târnăveni', 'Luduș', 'Sovata', 'Ungheni', 'Iernut', 'Sărmașu', 'Sărmașu'],
  'Neamț': ['Piatra Neamț', 'Roman', 'Bicaz', 'Roznov', 'Târgu Neamț', 'Bălțătești', 'Bicaz-Chei', 'Bicaz-Chei', 'Bicaz-Chei', 'Bicaz-Chei'],
  ...
  'Suceava': ['Suceava', 'Fălticeni', 'Rădăuți', 'Câmpulung Moldovenesc', 'Vatra Dornei', 'Gura Humorului', 'Salcea', 'Liteni', 'Milișăuți', 'Milișăuți'],
  ...
  'Vâlcea': ['Râmnicu Vâlcea', 'Drăgășani', 'Băbeni', 'Băile Govora', 'Băile Olănești', 'Brezoi', 'Călimănești', 'Horezu', 'Ocnele Mari', 'Ocnele Mari'],
